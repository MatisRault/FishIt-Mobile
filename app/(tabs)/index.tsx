import { StyleSheet, TouchableOpacity, Animated, TextInput, ScrollView, ActivityIndicator, Animated, TextInput, ScrollView, ActivityIndicator } from 'react-native';
...
export default function TabOneScreen() {
  ...
  const spotsToShow = React.useMemo((spot: FishSpot) => {
    if (searchQuery.trim()) {
